...
export function Footer() {
  return (
    <footer className="bg-charcoal text-brand-white">
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div className="flex flex-col items-center text-center gap-8">
          {/* Logo */}
          <LogoFull showTagline light />

          {/* Navigation */}
          <div className="flex gap-8 text-sm text-sand">
            <Link href="/about" className="hover:text-brand-white transition-colors">
              About
            </Link>
            <Link href="/services" className="hover:text-brand-white transition-colors">
              Services
            </Link>
            <Link href="/contact" className="hover:text-brand-white transition-colors">
              Contact
            </Link>
            <Link href="/portal" className="hover:text-brand-white transition-colors">
              Portal
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <a
              ...
              className="text-sand hover:text-brand-white transition-colors"
          ...
          {/* Copyright */}
          <p className="text-xs text-sand/50">
            &copy; {new Date().getFullYear()} The Feed. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
